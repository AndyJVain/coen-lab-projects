...
//     POSTCONDITION: This is a copy constructor, so the values from other are
//     copied over.
//
// DESTRUCTOR
//   ~polynomial( );
//     POSTCONDITION: The temporary array is deallocated if the array was
//     local
//
...
//     POSTCONDITION: If the exponent was larger than the array, a larger array is
//     allocated to make space for the higher exponent.
//
...
//     POSTCONDITION: The return value is a polynomial that is equal to the one
//     it was set to.
//
