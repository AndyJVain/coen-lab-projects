...
//
// COPY CONSTRUCTOR for the PriorityQueue class:
//   PriorityQueue(const PriorityQueue& other)
//     Postcondition: The PriorityQueue has the same queue as the PriorityQueue "other"
//
// DESTRUCTOR
//   ~PriorityQueue( )
//     Postcondition: All nodes in the Priority Queue are deleted
//
// ASSIGNMENT OPERATOR
//   operator =(const PriorityQueue& other)
//     Postcondition: The entries, priority, and order of PriorityQueue "other"
//     are copied over to the PriorityQueue.
//
...
// HELPER FUNCTION
//   void clear( )
//     Postcondition: The PriorityQueue is cleared by deleting all the nodes
//     and setting many_nodes = 0.
//
