...
//     This class is a template class, so there is no TYPEDEF used.
//
...
//
//   void list_piece(
//     node<Item>* start_ptr, node<Item>* end_ptr,
...
namespace coen70_lab7
{
    ...
    public:
    	...
    	// Constant and nonconstant member functions to retrieve the current data:
