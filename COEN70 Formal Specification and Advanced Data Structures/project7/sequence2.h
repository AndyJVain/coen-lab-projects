// FILE: sequence2.h
// TEMPLATE CLASS PROVIDED: sequence (part of the namespace main_savitch_5)
...
//    sequence::node_iterator is the data type for the node iterator
//
//  typedef const_node_iterator<Item> const_iterator
//    sequence::const_node_iterator is the data type for the constant node iterator
//
